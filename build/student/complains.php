        ...
        <div class="border rounded-xl border-gray-300 overflow-hidden">
          ...
          <div class="px-5 pb-5" data-accordion-content>
            <p class="text-sm text-gray-600">
              Each Course Card Includes The Course Title, Progress Status (Like 30% Or Completed), And A “Continue Learning” Or “View Details” Button.
            </p>
          </div>
        </div>
        <!-- Other FAQs same as your existing code -->
      </div>
    </div>
